...
def load_model():
    ...
    model_path = "models/brain_tumor_model.pth" if os.path.exists("models/brain_tumor_model.pth") else "brain_tumor_model.pth"
...
def register_user(username, password, confirm_password):
    ...
    try:
        ...
        return f"Account created. You can now log in as '{username}'.", gr.update(visible=True), gr.update(visible=False)
    ...
    with gr.Column(visible=True) as auth_panel:
        ...
        with gr.Tabs():
            with gr.Tab("Login"):
                ...
                login_msg = gr.Textbox(show_label=False, interactive=False, lines=1)
            with gr.Tab("Register"):
                ...
                reg_msg = gr.Textbox(show_label=False, interactive=False, lines=1)
